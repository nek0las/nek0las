...
| University | Degree |
|---|---|
| 🇳🇱 Vrije Universiteit Amsterdam & University of Amsterdam | MSc Joint Degree |
| 🇨🇳 Qingdao University of Science and Technology | BSc |
...
| Topic | Description |
|---|---|
| ⚙️ **RISC-V Assembly Semantics** | Formal specification of ISA behaviour |
| 🧠 **Axiomatic Memory Models** | Reasoning about concurrency at the hardware level |
| 📐 **Formal Methods** | Rigorous mathematical approaches to software & hardware correctness |
| 💻 **Computer Architecture** | Low-level design and performance of computing systems |
...
![Coq](https://img.shields.io/badge/Coq-EF4A34?style=for-the-badge&logo=coq&logoColor=white)
